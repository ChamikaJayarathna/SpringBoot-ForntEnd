...
useEffect(() => {
  const getIssueId = async () => {
      try {
          const response = await IssueServices.getIssueByID(issueID);
  ...
  const saveRequest = (e) => {
    ...
    IssueServices.updateIssue(issue, issueID)
      .then((res) => {
        ...
        <div className="row">
          <div className="card col-md-6 offset-md-3 mt-5">
            <div className="card-body">
              <h3 className="card-title text-center">Update Issue</h3>
              <form>
                ...
                <div className="mt-4">
                  <button type="button" className="btn btn-success" onClick={saveRequest}>Update</button>
...
export default UpdateIssueComponents